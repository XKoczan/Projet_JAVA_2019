        ...
        ajouter.addActionListener((ActionEvent e) -> {
            ...
            conf.addActionListener((ActionEvent evt) -> {
                ...
                try {
                    ...
                    dao_professeur.creer(new Professeur(dao_professeur.getCollection_professeur().size(), t1.getText(), t2.getText()),parseInt(t3.getText()));
